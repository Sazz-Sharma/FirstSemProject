...
function createStar(ids) {
    ...
    const containerWidth = document.getElementById(id_name).offsetWidth;
    const containerHeight = document.getElementById(id_name).offsetHeight;
    const maxX = containerWidth - star.offsetWidth -10;
    const maxY = containerHeight - star.offsetHeight -10;
    ...
    document.getElementById(id_name).appendChild(star);
